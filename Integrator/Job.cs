...
namespace Integrator
{
    public class Job
    {
        ...
        public Job()
        {
            ...
            log.Info("jobdone: PRIMAVERA_EMPRESA- " + PRIMAVERA_EMPRESA + " | PRIMAVERA_UTILIZADOR- " +
                     PRIMAVERA_UTILIZADOR + " | PRIMAVERA_PASSWORD- " + PRIMAVERA_PASSWORD);
        }
        ...
        private void TestReadQrCode()
        {
            IQrCodeReader qrCodeReader = new QrCodeReader();
            var result = qrCodeReader.ReadQrCode("C:\\Users\\catar\\Downloads\\transferir.png");
        }
        private void TestDocumentoInternoService()
        {
            ...
            var lines = new List<LinhaDocumentoInterno>
            {
            ...
            service.Create(
                new Primavera.Integration.Services.Models.DocumentoInterno.DocumentoInterno(1, DateTime.Now,
                    DateTime.Now, "ORC2", "2020", "", 1, "DEV.PRT.0000052/2020", "C1", "OBS",
                    "1d45ce9f-0d77-11eb-912a-00505601071b", lines), lines);
        }
    }
}