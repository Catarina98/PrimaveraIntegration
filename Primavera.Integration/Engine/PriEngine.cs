...
using Primavera.Integration.Disposable;
using StdBE100;
using StdPlatBS100;
using System;
using static StdBE100.StdBETipos;

namespace Primavera.Integration.Engine
{
    public sealed class PriEngine : DisposableBase
    {
        ...
        public static string Empresa { get; private set; }
